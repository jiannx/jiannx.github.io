...
export default function Bottom() {
  ...
  return (
    <Page.Container className="bg-secondary-content mt-24">
      <footer className="text-center p-10">
        <div>
          <div className="w-24 h-24 rounded-full bg-secondary flex justify-center items-center m-8 mx-auto">
            <IconDeer className="w-16 h-16 text-white" />
          </div>
